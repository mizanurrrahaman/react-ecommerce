                 ...
                 <div className="tabs mt-3">
                    <ul className="nav nav-tabs" id="myTab" role="tablist">
                      <li className="nav-item" role="presentation">
                         ...
                         href="#visa"> <img src="https://i.imgur.com/sB4jftM.png" width="80" alt=""/> </a> 
                     </li>
                     <li className="nav-item" role="presentation">
                         ...
                         href="#paypal"> <img src="https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcSES0StPvdPpPLi0LHqMG9NBEMjWELakd2G3uV64ivqwoNUBE-m-Vb8VAD1QXbhiSelssU&usqp=CAU" width="80" alt=""/> </a> 
                     </li>
                    </ul>
